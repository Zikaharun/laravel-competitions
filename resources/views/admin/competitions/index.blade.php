    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            <div class="py-12 ">
                ...
                {{-- List Competition --}}
                <div class="mt-6">
                    <h2 class="text-lg font-medium text-gray-700 mb-2">Daftar Competition</h2>
                    <ul class="divide-y divide-gray-200">
                        @forelse ($competitions as $competition)
                            <li class="py-2">
                                <span class="font-semibold text-gray-800">{{ $competition->name }}</span>
                                <p class="text-sm text-gray-500">{{ $competition->description }}</p>
